...
**Deliverable:** A GitHub repository URL (hosted demo link optional but encouraged) **Deadline:** 48 hours from receiving this assignment **Submit to:** hr@wexa.ai 
...
**3.  Save your connection details.** You will get a connection URI of the form 
   ...
   - bolt+s://<instance-id>.databases.cognodb.cloud and a generated password for the user "cognodb". The password is shown exactly once — copy or download it immediately and store it where your code reads its secrets. 
...
_Whatever you choose, the README must include a short "Why a graph database?" section explaining what your use case gains over a relational schema._ 
...
Wexa AI — Candidate Take-Home Assignment  ·  Page 3 of 3 
